...
myUI <- shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            "Welcome to the R Project interface for searching Australian government open data.",
            br(),
        # text input box
        textInput("text", label = h4("Input search keyword"), value = "Enter text..."),
        ...
        column(10,
               selectInput("select", label = h4("data.gov.au groups"),
